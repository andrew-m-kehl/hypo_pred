...
def main():
    ...
    ax_sig.set_ylim(40, 190) 
    ax_sig.grid(True, linestyle='--', alpha=0.5)
    ax_sig.legend(loc='upper right', fontsize='x-small', ncol=6)
    ax_sig.axhline(y=65, color='blue', linestyle=':', alpha=0.3, label="65mmHg (Hypotension)")
    ...
    #     ax_di_base.text(0.01, 0.85, "Base DP", transform=ax_di_base.transAxes, color='magenta', fontweight='bold', va='top')
    #     ax_di_base.set_ylabel("DP Value")
    #     ax_di_base.grid(True, linestyle='--', alpha=0.3)
    #     ax_di_base.set_ylim(0, 1.0) 
    #     ax_di_base.axhline(y=0.2, color='blue', linestyle=':', alpha=0.3, label="DP baseline")
    #     # Delta DI
    ...
    #     ax_pi_base.text(0.01, 0.85, "Base PI Index", transform=ax_pi_base.transAxes, color='teal', fontweight='bold', va='top')
    #     ax_pi_base.set_ylabel("PI Value")
    #     ax_pi_base.grid(True, linestyle='--', alpha=0.3)
    #     ax_pi_base.set_ylim(0.0, 2.0) 
    #     ax_pi_base.axhline(y=1.2, color='blue', linestyle=':', alpha=0.3, label="PI baseline")
    #     # Delta PI
